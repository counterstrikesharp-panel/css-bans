<ul class="nav nav-tabs" id="weaponTab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link {{ Request::is('*agents/skins*') ? 'active' : '' }}" id="agents-tab-icon" data-bs-toggle="tab" data-bs-target="#agents-tab-pane" type="button" role="tab" aria-controls="agents-tab-pane" aria-selected="{{ Request::is('agents') ? 'true' : 'false' }}">
            <a href="{{getAppSubDirectoryPath()}}/agents/skins"><img src="https://raw.githubusercontent.com/Nereziel/cs2-WeaponPaints/main/website/img/skins/agent-4726.png" alt="Agents" width="50" height="50"></a>
        </button>
    </li>
    <li class="nav-item">
        <button class="nav-link {{ Request::is('*gloves/skins*') ? 'active' : '' }}" id="glove-dropdown-tab" data-bs-toggle="modal" data-bs-target="#gloveModal" type="button">
            <a href="{{ !Request::is('*gloves/skins*') ? getAppSubDirectoryPath()."/gloves/skins" : 'javascript:void(0);'}}"><img src="https://raw.githubusercontent.com/Nereziel/cs2-WeaponPaints/main/website/img/skins/studded_brokenfang_gloves-10085.png" alt="Gloves" width="50" height="50"></a>
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link {{ Request::is('*music/kits*') ? 'active' : '' }}" id="music-tab-icon" data-bs-toggle="tab" data-bs-target="#music-tab-pane" type="button" role="tab" aria-controls="music-tab-pane" aria-selected="{{ Request::is('music') ? 'true' : 'false' }}">
            <a href="{{getAppSubDirectoryPath()}}/music/kits"><img src="https://raw.githubusercontent.com/Nereziel/cs2-WeaponPaints/main/website/img/skins/music_kit-3.png" alt="Music" width="50" height="50"></a>
        </button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link {{ Request::is('*pins/pin*') ? 'active' : '' }}" id="pin-tab-icon" data-bs-toggle="tab" data-bs-target="#pin-tab-pane" type="button" role="tab" aria-controls="pin-tab-pane" aria-selected="{{ Request::is('pin') ? 'true' : 'false' }}">
            <a href="{{getAppSubDirectoryPath()}}/pins/pin"><img src="https://raw.githubusercontent.com/Nereziel/cs2-WeaponPaints/main/website/img/skins/collectible-6121.png" alt="Music" width="50" height="50"></a>
        </button>
    </li>
    <li class="nav-item">

...
<x-base-layout :scrollspy="false">
    ...
    <x-slot:footerFiles>
        ...
        <script>
            ...
            // Replace the table row creation function to generate proper links to the details page
            function createTableRowForGroup(logGroup) {
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ url('/admin/logs/details') }}/${logGroup.id}" class="action-btn">
                            <i class="fas fa-eye mr-1"></i> View Timeline
                        </a>
                    </td>
                </tr>`;
            }

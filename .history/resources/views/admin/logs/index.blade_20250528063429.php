...
<x-base-layout :scrollspy="false">
    ...
    <x-slot:footerFiles>
        ...
        <script>
            ...
            // Replace the table row creation function to link to the details page instead of showing modal
            function createTableRowForGroup(logGroup) {
                ...
                // Create a link to the details page instead of a modal button
                return `
                <tr>
                    <td>
                    ...
                    <td>
                        <a href="{{ route('admin.logs.details') }}/${logGroup.id}" class="action-btn">

...
<x-base-layout :scrollspy="false">
    ...
    <x-slot:footerFiles>
        ...
        <script>
            ...
            // Replace the table row creation function to correctly pass the log ID to the details route
            function createTableRowForGroup(logGroup) {
                ...
                // Create a link to the details page with the proper log ID
                return `
                <tr>
                    <td>
                    ...
                    <td>
                        <a href="{{ route('admin.logs.details', ['id' => '__ID__']) }}".replace('__ID__', ${logGroup.id}) class="action-btn">

    ...
    <x-slot:footerFiles>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                // Replace the click handler to redirect to a details page instead of showing a modal
                $(document).on('click', '.view-details', function(e) {
                    e.preventDefault();
                    
                    // Get the log ID and redirect to the details page
                    const logId = $(this).data('log-id');
                    window.location.href = "{{ route('admin.logs.show', '') }}/" + logId;
                });
            ...
            function createTableRowForGroup(logGroup) {
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.logs.show', '') }}/${logGroup.id}" class="action-btn view-details" data-log-id="${logGroup.id}">

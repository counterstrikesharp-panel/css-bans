...
class AdminLogController extends Controller
{
    ...
    {
        // Load the log entry with basic information
        $log = AdminLog::findOrFail($id);
        
        // Decode the details field to get server-specific information
        $serverDetails = [];
        if ($log->details) {
            if (is_string($log->details)) {
                try {
                    ...
                    $serverDetails = [json_decode('{"error": "Could not parse details data"}')];
                }

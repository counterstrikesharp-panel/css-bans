...
class StoreAdminRequest extends FormRequest
{
    ...
    {
        return [
            'steam_id.required' => 'The SteamID64 field is required.',
            'steam_id.numeric' => 'The SteamID64 must be a number.',
            'steam_id.digits' => 'The SteamID64 must be exactly 17 digits.',
            'player_name.required' => 'The player name is required.',
            'server_ids.required' => 'The server field is required.',
            'server_ids.exists' => 'The selected server is invalid.',
            'permissions.required_without' => 'At least one permission or group is required.',
            'permissions.exists' => 'The selected permission is invalid.',
            'ends.after' => 'The end date must be a future date.',
            'immunity.required' => 'Immunity field is required.',
        ];
    }
}
